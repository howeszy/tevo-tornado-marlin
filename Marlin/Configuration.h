...
#define STRING_CONFIG_H_AUTHOR "(Matthew Howes, BLTouch TEVO Tornado)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "TEVO Tornado" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Marlin 1.1.8"         // will be shown during bootup in line 2
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 8.09
  #define DEFAULT_Ki 0.97
  #define DEFAULT_Kd 16.89
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 48.37
  #define DEFAULT_bedKi 8.20
  #define DEFAULT_bedKd 71.33
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.765, 79.765, 399.2901, 425.532 }
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -62  // X offset: -left  +right  [of the nozzle]
